  ...
  <div class="content">
	...
	<view class="rules">
       ...
       <view class="rulesbody">		
		   <p>1. 本活动优惠范围：1）续订云主机（含带宽、磁盘）享9折；2）续订云主机（含带宽、磁盘）且续订周期为1/2/3/5年的订单，可在包年优惠基础上再享8.5折；3）升级云主机（含带宽、磁盘）享8折；</p> 
		   <p>2. 本次活动面向中移云完成实名注册的预付费用户续订/升级；</p> 
		   <p>3. 续订及升级活动不支持代金券支付，也不支持与其他优惠活动及优惠券叠加使用；</p> 
		   <p>4. 若发生退款，详细请参照 官网退货说明 >，部分云产品不支持自助退款，若产品不支持自助退款，您可在对应的产品工单分类中提交工单申请退款。退款前，请先确定是否满足退货说明的条件，且请确保数据已迁移，发生退款后不再恢复参与资格。 </p>
		   <p>*如用户在活动中存在隐瞒、虚构、作弊、欺诈或通过其他非正常手段规避活动规则、获取不当利益的行为，例如：作弊领取、恶意套现、网络攻击、虚假交易等，中移云有权收回相关权益、取消用户的活动参与资格，撤销违规交易，必要时追究违规用户的法律责任；活动名称仅为方便用户理解参考使用，不具有效力，实际活动内容以具体活动规则为准。</p>
		</view>
	</view>
